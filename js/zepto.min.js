...
var Zepto = function () {
    ...
    function p(t) {
        return"children"in t ? k.call(t.children) : T.map(t.childNodes, function (t) {
    ...
    return Y.matches = function (t, e) {
        ...
        var i, r, a;
        return $.test(t) && (i = T(Z.createElement(RegExp.$1))), i || (t.replace && (t = t.replace(_, "<$1></$2>")), e === E && (e = L.test(t) && RegExp.$1), e in V || (e = "*"), a = V[e], a.innerHTML = "" + t, i = T.each(k.call(a.childNodes), function () {
            a.removeChild(this)
        ...
        if ("string" == typeof t)if (t = t.trim(), "<" == t[0] && L.test(t))i = Y.fragment(t, RegExp.$1, n), t = null; else {
            ...
            if (Y.isZ(t))return t;
            if (Q(t))i = s(t); else if (r(t))i = [t], t = null; else if (L.test(t))i = Y.fragment(t.trim(), RegExp.$1, n), t = null; else {
                if (n !== E)return T(n).find(t);
                i = Y.qsa(Z, t)
            }
        }
    ...
    }, T.contains = Z.documentElement.contains ? function (t, e) {
    ...
    }), T.fn = {constructor: Y.Z, length: 0, forEach: A.forEach, reduce: A.reduce, push: A.push, sort: A.sort, splice: A.splice, indexOf: A.indexOf, concat: function () {
        var t, e, n = [];
        ...
        return H.test(Z.readyState) && Z.body ? t(T) : Z.addEventListener("DOMContentLoaded", function () {
            t(T)
        }, !1), this
    }, get: function (t) {
        ...
        return"string" != typeof t || 1 in arguments ? this.each(function (n) {
            if (1 === this.nodeType)if (r(t))for (j in t)y(this, j, t[j]); else y(this, t, g(this, e, n, this.getAttribute(t)))
        ...
        if (!T.contains(Z.documentElement, this[0]))return{top: 0, left: 0};
        ...
        return t ? this.each(function (n) {
            var i = T(this), r = g(this, t, n, b(this));
        ...
        if (this.length) {
            var t = this[0], e = this.offsetParent(), n = this.offset(), i = q.test(e[0].nodeName) ? {top: 0, left: 0} : e.offset();
    ...
    }), Y.Z.prototype = d.prototype = T.fn, Y.uniq = O, Y.deserializeValue = x, T.zepto = Y, T
}();
window.Zepto = Zepto, void 0 === window.$ && (window.$ = Zepto), function (t) {
    ...
    var m, v, g = 0, y = window.document, b = /<script\b[^<]*(?:(?!<\/script>)<[^<]*)*<\/script>/gi, x = /^(?:text|application)\/javascript/i, w = /^(?:text|application)\/xml/i, E = "application/json", j = "text/html", T = /^\s*$/, C = y.createElement("a");
    C.href = window.location.href, t.active = 0, t.ajaxJSONP = function (e, n) {
        ...
        var b, x = u.accepts[d], w = {}, E = function (t, e) {
            w[t.toLowerCase()] = [t, e]
        }, j = /^([\w-]+:)\/\//.test(u.url) ? RegExp.$1 : window.location.protocol, S = u.xhr(), O = S.setRequestHeader;
        ...
        if (S.setRequestHeader = E, S.onreadystatechange = function () {
            if (4 == S.readyState) {
                S.onreadystatechange = c, clearTimeout(b);
                var e, n = !1;
        ...
        }, o(S, u) === !1)return S.abort(), s(null, "abort", S, u, p), S;
    ...
    function e(t, e) {
        var n = this.os = {}, i = this.browser = {}, r = t.match(/Web[kK]it[\/]{0,1}([\d.]+)/), o = t.match(/(Android);?[\s\/]+([\d.]+)?/), a = !!t.match(/\(Macintosh\; Intel /), s = t.match(/(iPad).*OS\s([\d_]+)/), u = t.match(/(iPod)(.*OS\s([\d_]+))?/), c = !s && t.match(/(iPhone\sOS)\s([\d_]+)/), l = t.match(/(webOS|hpwOS)[\s\/]([\d.]+)/), f = /Win\d{2}|Windows/.test(e), h = t.match(/Windows Phone ([\d.]+)/), p = l && t.match(/TouchPad/), d = t.match(/Kindle\/([\d.]+)/), m = t.match(/Silk\/([\d._]+)/), v = t.match(/(BlackBerry).*Version\/([\d.]+)/), g = t.match(/(BB10).*Version\/([\d.]+)/), y = t.match(/(RIM\sTablet\sOS)\s([\d.]+)/), b = t.match(/PlayBook/), x = t.match(/Chrome\/([\d.]+)/) || t.match(/CriOS\/([\d.]+)/), w = t.match(/Firefox\/([\d.]+)/), E = t.match(/\((?:Mobile|Tablet); rv:([\d.]+)\).*Firefox\/[\d.]+/), j = t.match(/MSIE\s([\d.]+)/) || t.match(/Trident\/[\d](?=[^\?]+).*rv:([0-9.].)/), T = !x && t.match(/(iPhone|iPod|iPad).*AppleWebKit(?!.*Safari)/), C = T || t.match(/Version\/([\d.]+)([^S](Safari)|[^M]*(Mobile)[^S]*(Safari))/);
        (i.webkit = !!r) && (i.version = r[1]), o && (n.android = !0, n.version = o[2]), c && !u && (n.ios = n.iphone = !0, n.version = c[2].replace(/_/g, ".")), s && (n.ios = n.ipad = !0, n.version = s[2].replace(/_/g, ".")), u && (n.ios = n.ipod = !0, n.version = u[3] ? u[3].replace(/_/g, ".") : null), h && (n.wp = !0, n.version = h[1]), l && (n.webos = !0, n.version = l[2]), p && (n.touchpad = !0), v && (n.blackberry = !0, n.version = v[2]), g && (n.bb10 = !0, n.version = g[2]), y && (n.rimtabletos = !0, n.version = y[2]), b && (i.playbook = !0), d && (n.kindle = !0, n.version = d[1]), m && (i.silk = !0, i.version = m[1]), !m && n.android && t.match(/Kindle Fire/) && (i.silk = !0), x && (i.chrome = !0, i.version = x[1]), w && (i.firefox = !0, i.version = w[1]), E && (n.firefoxos = !0, n.version = E[1]), j && (i.ie = !0, i.version = j[1]), C && (a || n.ios || f) && (i.safari = !0, n.ios || (i.version = C[1])), T && (i.webview = !0), n.tablet = !!(s || b || o && !t.match(/Mobile/) || w && t.match(/Tablet/) || j && !t.match(/Phone/) && t.match(/Touch/)), n.phone = !(n.tablet || n.ipod || !(o || c || l || v || g || x && t.match(/Android/) || x && t.match(/CriOS\/([\d.]+)/) || w && t.match(/Mobile/) || j && t.match(/Touch/)))
    }
    ...
    }, v = {}, g = {}, y = "onfocusin"in window, b = {focus: "focusin", blur: "focusout"}, x = {mouseenter: "mouseover", mouseleave: "mouseout"};
    g.click = g.mousedown = g.mouseup = g.mousemove = "MouseEvents", t.event = {add: s, remove: u}, t.proxy = function (n, i) {
    ...
    var w = function () {
        ...
        return!1
    }, j = /^([A-Z]|returnValue$|layer[XY]$)/, T = {preventDefault: "isDefaultPrevented", stopImmediatePropagation: "isImmediatePropagationStopped", stopPropagation: "isPropagationStopped"};
    ...
    var r, o, a, s, u, c, l, f, h, p, d = "", m = {Webkit: "webkit", Moz: "", O: "o"}, v = document.createElement("div"), g = /^((translate|rotate|scale)(X|Y|Z|3d)?|matrix(3d)?|perspective|skew(X|Y)?)$/i, y = {};
    t.each(m, function (t, n) {
        ...
        var b, x, w, E = {}, j = "", T = this, C = t.fx.transitionEnd, S = !1;
        if (r === e && (r = t.fx.speeds._default / 1e3), v === e && (v = 0), t.fx.off && (r = 0), "string" == typeof i)E[l] = i, E[f] = r + "s", E[p] = v + "s", E[h] = d || "linear", C = t.fx.animationEnd; else {
            x = [];
            for (b in i)g.test(b) ? j += b + "(" + i[b] + ") " : (E[b] = i[b], x.push(n(b)));
            j && (E[o] = j, x.push(o)), r > 0 && "object" == typeof i && (E[a] = x.join(", "), E[s] = r + "s", E[c] = v + "s", E[u] = d || "linear")
        }
        return w = function (e) {
    ...
    var i = t.zepto, r = i.qsa, o = i.matches, a = t.expr[":"] = {visible: function () {
